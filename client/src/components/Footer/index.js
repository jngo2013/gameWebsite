...
function Footer() {
  return (
    <Container fluid className='test2'>
      <Row className="row2">
        

        <Col className="testCol2">
          <div className="X">
            <h4>Social Media</h4>
            <ul>
              <li>something</li>
        ...
        <Col className="testCol2">
            <Image src="https://scontent-sjc3-1.xx.fbcdn.net/v/t1.0-0/p370x247/67529268_665627333913015_2337246147929702400_n.jpg?_nc_cat=110&_nc_sid=85a577&_nc_ohc=kSPsdRngwLcAX9UJVsW&_nc_ht=scontent-sjc3-1.xx&tp=6&oh=af476855dd55ba3c2227e2b324cb64cc&oe=5FA54906" className="testImg2" roundedCircle />
        </Col>
